...
instructions = pygame.image.load("Imagenes\\instructions.png")
about_image = pygame.image.load("Imagenes\\about.png")
...
def main(lvl,score, name):
    ...
    #VERIFICA CUAL MUSICA SE REPRODUCE DE ACUERDO AL NIVEL
    if lvl == 1:
